UNIX BUILD NOTES
====================
Some notes on how to build Radium More in Unix.

(for OpenBSD specific instructions, see [build-openbsd.md](build-openbsd.md))

Note
---------------------
Always use absolute paths to configure and compile radium and the dependencies,
...
memory available when compiling Radium13. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build Radium13 without wallet.
...
Notes
-----
The release is built with GCC and then "strip radium13d" to strip the debug
...
Berkeley DB
-----------
It is recommended to use Berkeley DB 6.2.38 If you have to build it yourself:
...
wget https://github.com/RadiumCore/BDB6.2.38/releases/download/6.2.38/db-6.2.38.NC.tar.gz
...
# Configure Validity to use our own-built instance of BDB
cd $BITCOIN_ROOT
./autogen.sh
...
Security
--------
To help make your radium installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, radium should be built with a non-executable stack
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, radium may be compiled in
...
As mentioned above, when maintaining portability of the wallet between the standard Radium13 More distributions and independently built
