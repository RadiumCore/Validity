...
void SignVerifyMessageDialog::on_signMessageButton_SM_clicked()
{
    ...
    {
        ui->statusLabel_SM->setStyleSheet("QLabel { color: #e05555; }");
    ...
    ui->statusLabel_SM->setStyleSheet("QLabel { color: #43b581; }");
...
void SignVerifyMessageDialog::on_verifyMessageButton_VM_clicked()
{
    ...
    if (!IsValidDestination(destination))
    {
        ui->statusLabel_VM->setStyleSheet("QLabel { color: #e05555; }");
    ...
    ui->statusLabel_VM->setStyleSheet("QLabel { color: #43b581; }");
